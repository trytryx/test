import { ChainId, JSBI, Percent, Token, WETH } from 'sdkv2'
...
export const ETH = new Token(ChainId.MAINNET, '0xd19A6Fe48395a7BE37dDC16508dD180D59867012', 18, 'HYPER', 'HYPER FINANCE')
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [...WETH_ONLY[ChainId.MAINNET], DAI, USDC, USDT, ETH]
}
